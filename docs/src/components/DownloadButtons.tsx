...
export default function DownloadButtons({ height = 60 }: DownloadButtonsProps) {
  return (
    <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap', marginBottom: '20px', justifyContent: 'center' }}>
      <a href="https://addons.mozilla.org/en-US/firefox/addon/tablissng/" style={{ transition: 'opacity 0.15s ease' }}>
        <img
      ...
      <a href="https://chromewebstore.google.com/detail/tablissng/dlaogejjiafeobgofajdlkkhjlignalk" style={{ transition: 'opacity 0.15s ease' }}>
        <img
      ...
      <a href="https://microsoftedge.microsoft.com/addons/detail/tablissng/mkaphhbkcccpgkfaifhhdfckagnkcmhm" style={{ transition: 'opacity 0.15s ease' }}>
        <img
