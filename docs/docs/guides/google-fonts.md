...
4. Copy the `@import` line (the part between `<style>` and `</style>`).
   ...
   <img src="/TablissNG/docs/img/screenshots/guides/google_fonts_export_page.png" alt="Google Fonts Import Example" width="600" />
...
8. Back in TablissNG, paste the font name in the **Font** field under a widget's Font Settings.
   ...
   <img src="/TablissNG/docs/img/screenshots/guides/google_fonts_used.png" alt="Google Font applied to Clock widget" width="600" />
